...
using fume::get_func_parms;

template<class T>
static MC_STATUS get_value( int            msg,
                            unsigned long  tag,
                            T&             value )
{
...
MC_STATUS MC_Get_Value_To_Double( int           MsgFileItemID,
                                  unsigned long Tag,
                                  double*       Value )
{
    return Value == nullptr ? MC_NULL_POINTER_PARM :
                              get_value( MsgFileItemID, Tag, *Value );
}

MC_STATUS MC_Get_Value_To_Float( int           MsgFileItemID,
                                 unsigned long Tag,
                                 float*        Value )
{
    return Value == nullptr ? MC_NULL_POINTER_PARM :
...
MC_STATUS MC_Get_Value_To_Int( int           MsgFileItemID,
                               unsigned long Tag,
                               int*          Value )
{
    return Value == nullptr ? MC_NULL_POINTER_PARM :
...
MC_STATUS MC_Get_Value_To_ShortInt( int           MsgFileItemID,
                                    unsigned long Tag,
                                    short int*    Value )
{
    return Value == nullptr ? MC_NULL_POINTER_PARM :
...
MC_STATUS MC_Get_Value_To_LongInt( int           MsgFileItemID,
                                   unsigned long Tag,
                                   long int*     Value )
{
    return Value == nullptr ? MC_NULL_POINTER_PARM :
...
MC_STATUS MC_Get_Value_To_String( int           MsgFileItemID,
                                  unsigned long Tag,
                                  MC_size_t     BufferSize,
                                  char*         Value )
{
    get_string_parms parms( Value, BufferSize );
    return get_value( MsgFileItemID, Tag, parms );
}

MC_STATUS MC_Get_Value_To_UnicodeString( int           MsgFileItemID,
                                         unsigned long Tag,
                                         MC_size_t     BufferSize,
                                         int*          ValueSize,
                                         MC_UChar*     Value )
{
    ...
    if( ValueSize != nullptr )
    {
        ...
        ret = get_value( MsgFileItemID, Tag, parms );
        if( ret == MC_NORMAL_COMPLETION )
        {
        ...
        {
            // Do nothing. Returns error from get_value
        }
    }
    else
    {
...
MC_STATUS MC_Get_Value_To_UInt( int           MsgFileItemID,
                                unsigned long Tag,
                                unsigned int* Value )
{
    return Value == nullptr ? MC_NULL_POINTER_PARM :
...
MC_STATUS MC_Get_Value_To_UShortInt( int             MsgFileItemID,
                                     unsigned long   Tag,
...
MC_STATUS MC_Get_Value_To_ULongInt( int            MsgFileItemID,
                                    unsigned long  Tag,
                                    unsigned long* Value )
{
    return Value == nullptr ? MC_NULL_POINTER_PARM :
...
MC_STATUS MC_Get_Value_To_Buffer( int           MsgFileItemID,
                                  unsigned long Tag,
                                  MC_size_t     BufferSize,
                                  char*         Value,
                                  int*          ValueSize )
{
    ...
    if( ValueSize != nullptr )
    {
        get_buf_parms parms( Value, BufferSize );
        ret = get_value( MsgFileItemID, Tag, parms );
...
MC_STATUS MC_Get_Value( int           MsgFileItemID,
                        unsigned long Tag,
                        MC_DT         DataType,
                        MC_size_t     BufferSize,
                        void*         Value,
    ...
    if( Value != nullptr && ValueSize != nullptr )
    {
        switch( DataType )
        {
            case String_Type:
            {
                ...
                ret = MC_Get_Value_To_String( MsgFileItemID,
                                              Tag,
                                              BufferSize,
                                              ptr );
                if( ret == MC_NORMAL_COMPLETION )
            ...
            case Int_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(int) ) )
                {
                    ...
                    ret = MC_Get_Value_To_Int( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case UInt_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(unsigned int) ) )
                {
                    ...
                    ret = MC_Get_Value_To_UInt( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case ShortInt_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(short) ) )
                {
                    ...
                    ret = MC_Get_Value_To_ShortInt( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case UShortInt_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(unsigned short) ) )
                {
                    ...
                    ret = MC_Get_Value_To_UShortInt( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case LongInt_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(long) ) )
                {
                    ...
                    ret = MC_Get_Value_To_LongInt( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case ULongInt_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(unsigned long) ) )
                {
                    ...
                    ret = MC_Get_Value_To_ULongInt( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case Float_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(float) ) )
                {
                    ...
                    ret = MC_Get_Value_To_Float( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case Double_Type:
            {
                if( BufferSize >= static_cast<MC_size_t>( sizeof(double) ) )
                {
                    ...
                    ret = MC_Get_Value_To_Double( MsgFileItemID, Tag, ptr );
                    if( ret == MC_NORMAL_COMPLETION )
                    {
            ...
            case Buffer_Type:
            {
                ret = MC_Get_Value_To_Buffer( MsgFileItemID,
                                              Tag,
                                              BufferSize,
...
MC_STATUS MC_Get_Value_To_Function( int              MsgFileItemID,
                                    unsigned long    Tag,
                                    void*            UserInfo,
                                    GetValueCallback YourGetFunction )
{
    get_func_parms parms = { YourGetFunction, UserInfo, MsgFileItemID, Tag };
    return get_value( MsgFileItemID, Tag, parms );
}
