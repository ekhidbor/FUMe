...
static constexpr size_t MAX_UT_LEN = 0xFFFFFFFEu;

%% write data;

bool validate_ut( const string& val )
{
    bool ok = false;

    if( val.size() <= MAX_UT_LEN )
    {
        int cs = 0;
